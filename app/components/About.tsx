...
import CheckedBox from './Symbols/CheckedBox';
    ...
    <div className='flex flex-col gap-12 w-full h-screen'>
        <div className={`flex flex-col gap-3 w-full mb-3`}>
          <div className='flex gap-4 items-center'>
            <div>
<div className=' w-7 h-7 bg-foreground' />
            </div>
            
            <h2 className={` text-foreground text-3xl ${SemiBold.className}`}>About me</h2>
            <div className='h-[2px] flex-grow  bg-foreground'></div>
          </div>
          
          
        </div>
        
        <div className='flex w-full justify-between items-center gap-18'>
          
          <div className='w-[100%] '><p className='text-lg leading-normal'>Full‑Stack Developer with a B.S. in <span className={`${SemiBold.className} text-accent`}>Software Engineering</span> (2023 graduate)
             and 1+ year of hands-on experience building responsive, scalable web applications using React, Spring Boot, and Laravel.
              Skilled in JavaScript, Tailwind CSS, MySQL, and RESTful API development. <br /> <br />
              </p></div>
        </div>

        <div className='w-full flex gap-15'>
          {/* info */}
          <div className='flex lg:flex-row flex-col flex-1  gap-6 text-sm '>
          {/* left col */}
            <div className='flex flex-col gap-6 lg:w-1/2 w-full'>
          <div className='flex gap-3 items-center '>
            <CheckedBox/>
            <div className='flex w-full gap-3 lg:justify-normal justify-between'>
<span className={`${SemiBold.className}`}>Name :</span>
          ...
          <div className='flex gap-3 items-center'>
            <CheckedBox/>
            <div className='flex w-full gap-3 lg:justify-normal justify-between'>
<span className={`${SemiBold.className}`}>Age :</span>
            <span>25</span>
            </div>
          ...
          <div className='flex gap-3 items-center'>
            <CheckedBox/>
            <div className='flex w-full gap-3 lg:justify-normal justify-between'>
<span className={`${SemiBold.className}`}>Major :</span>
            <span>SE</span>
            </div>
          ...
          <div className='flex gap-3 items-center'>
            <CheckedBox/>
            <div className='flex w-full gap-3 lg:justify-normal justify-between'>
<span className={`${SemiBold.className}`}>Experience :</span>
            <span>1 Year</span>
            </div>
          ...
          <div className='w-[45%] flex flex-col gap-3'>
            {/* react */}
            <div className='flex gap-3 items-center'>
              <div className='w-12 h-12 border-3 border-foreground flex justify-center items-center'>
                <svg className="w-12 h-12 text-[#21A1F1] " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <path d="M12.215 13.773a1.792 1.792 0 1 0-1.786-1.8v.006a1.787 1.787 0 0 0 1.786 1.794Z"/>
              ...
              <div className='flex flex-col justify-center w-full gap-1'>
                <div className='w-full h-6  px-1'>
                                  <span className={`${SemiBold.className} text-sm`}>
                  React JS
                </span>
                </div>

                <div className='w-full h-5 border-2 border-foreground/90 flex gap-[2px] bg-foreground/90 items-center overflow-hidden'>
                  {Array.from({length:13},(_,i)=>
                  <div key={i} className={`w-1/12 h-6  ${i>8?'bg-subtle':'bg-[#21A1F1]'}`}>
...
<path fill="#8bc34a" d="M43.982,23.635c0.069-4.261-0.891-9.328-2.891-15.273l-1.568-4.662l-2.13,4.433 c-0.114,0.237-0.244,0.469-0.38,0.698C33.514,5.827,28.974,4,24,4C12.954,4,4,12.954,4,24c0,11.046,8.954,20,20,20s20-8.954,20-20 C44,23.877,43.984,23.758,43.982,23.635z"></path><path fill="#fff" d="M39.385 32.558c-3.123 4.302-8.651 4.533-13.854 4.442H18.75h-1.938c4.428-1.593 7.063-1.972 9.754-3.4 5.068-2.665 10.078-8.496 11.121-14.562-1.93 5.836-7.779 10.85-13.109 12.889-3.652 1.393-10.248 2.745-10.248 2.745l-.267-.145C9.573 32.268 9.437 22.214 17.6 18.968c3.574-1.423 6.993-.641 10.854-1.593 4.122-1.012 8.89-4.208 10.83-8.375C41.456 15.667 44.07 26.106 39.385 32.558L39.385 32.558zM15.668 38.445C15.386 38.795 14.955 39 14.505 39c-.823 0-1.495-.677-1.495-1.5s.677-1.5 1.495-1.5c.341 0 .677.118.941.336C16.086 36.855 16.186 37.805 15.668 38.445L15.668 38.445z"></path>
              ...
              <div className='flex flex-col justify-center w-full gap-1'>
                ...
                <div className='w-full h-5 border-2 border-foreground/90 flex gap-[2px] bg-foreground/90 items-center overflow-hidden'>
                  {Array.from({length:13},(_,i)=>
                  <div key={i} className={`w-1/12 h-6  ${i>5?'bg-subtle':'bg-[#8bc34a]'}`}>
